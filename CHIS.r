# The objective is to create a Marimekko/Mosaic plot of
# the CHIS data. At the end of this file is a generalization
# of the code to a function, which is then used on other data sets.
...
# Below is further refinement of the plot
...
# Generalizing the code to a mosaic plot function
